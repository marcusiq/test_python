...
class DragonQuest(object):
    ...
    def play(self):
        ...
        for player in self.players:
            # The if statement also needs to check the game is not over before the next player can have a turn.
            if player.active and not self.game_over: # If a player has been eliminated, they don't get to play again.
...
class Player(object):
   ...
   """
    # There can only be one __init__ constructor at a time. Perhaps another game might use the above form.
    ...
    def chooseCave(self):
        ...
        else: # Player is a human, and will indicate the cave of their choice by entering that at the terminal.
    ...
    def check_if_game_over(self):
        if self.number_of_golden_rings >= 3:  # The possibility of more than 3 rings is used for debugging.
...
if __name__ == "__main__":
    player1 = Player("Agent Smith")  # <-- Changed to Agent Smith
    player1.type = True  # Player 1 is a computer.
    player1.number_of_golden_rings = 0

    # This line can be used for debugging as asked in the grading scheme part 2B.
    # To test this quickly during peer review, help Agent Smith cheat, by adding the line:
    # player1.number_of_golden_rings = 3
    ...
    player3.type = True  # Player 3 is a computer.
